                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const MilkBased(),
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
                ...
                itemBuilder: (context, index) {
                  if (index == 0) {
                    return _buildCarouselItem(
                      imagePath: "asset/images/cake_box_oreo.png",
                      title: "Cke Box Oreo",
                      subtitle: "With topping oreo",
                      rating: "4.3",
                    );
                  } else if (index == 1) {
                    return _buildCarouselItem(
                      imagePath: "asset/images/lava_cake.png",
                      title: "Lava Cake",
                    ...
                    return _buildCarouselItem(
                      imagePath: "asset/images/pancake.png",
                      title: "Pancake",
                      subtitle: "Creamy ham and cheese mixture",
                      rating: "4.7",
                    );
                  }
                },
