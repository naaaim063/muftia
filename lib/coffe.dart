                ...
                itemBuilder: (context, index) {
                  if (index == 0) {
                    return _buildCarouselItem(
                      imagePath: "asset/images/cappucino.png",
                      title: "Cappucino",
                      subtitle: "With creamy milk",
                      rating: "4.7",
                    );
                  } else if (index == 1) {
                    return _buildCarouselItem(
                      imagePath: "asset/images/black_coffe.png",
                      title: "Americcano",
                    ...
                    return _buildCarouselItem(
                      imagePath: "asset/images/latte.png",
                      title: "Latte",
                      subtitle: "Soft creamy taste",
                      rating: "4.8",
                    );
                  }
                },
